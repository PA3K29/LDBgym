      ...
      <div className="py-6 sm:py-8 lg:py-10">
        <div className="overflow-hidden border-y border-white/10 bg-neutral-950">
          <div className="relative min-h-[640px] w-full sm:min-h-[620px] lg:min-h-[720px]">
            ...
            <div className="absolute inset-0 z-10 flex items-start justify-center px-6 pt-12 pb-8 text-center sm:px-10 sm:pt-20 lg:pt-24">
              <div className="max-w-5xl">
                <span className="mb-4 inline-flex w-fit rounded-full border border-red-500/30 bg-red-500/10 px-4 py-2 text-sm text-red-300 sm:text-base">
                  {heroData.badge}
                </span>
                <h1 className="text-4xl font-semibold uppercase tracking-wide text-white sm:text-6xl lg:text-7xl">
                  {heroData.title}
                </h1>
                <p className="mx-auto mt-6 max-w-4xl text-base leading-8 text-neutral-200 sm:text-2xl sm:leading-10">
                  {heroData.subtitle}
                </p>
                ...
                <div className="mt-8 grid gap-5 sm:grid-cols-3">
                  {heroData.stats.map((stat) => (
                    <div key={stat.label} className="text-center">
                      ...
                      <div className="mt-1 text-sm text-neutral-300 sm:text-base">{stat.label}</div>
                    </div>
                  ))}
                </div>
              </div>
